...
<body>
	<div class="nav">
		...
		<div class="nav-right">
			...
			?>
			<!-- pathi arian -->
			<li><a class="spanat <?php active('dashboard.php');?>" href="http://localhost/PHP_project/dashboard/dashboard.php">Home</a></li>
		    <li><a class="spanat <?php active('languages.php');?>" href="http://localhost/PHP_project/dashboard/languages.php">Languages</a></li>
		    <li><a class="spanat <?php active('quiz.php');?>" href="http://localhost/PHP_project/dashboard/quiz.php">Quiz</a></li>
		    <li><a class="spanat <?php active('contactus.php');?>" href="http://localhost/PHP_project/dashboard/contactus.php">Contact Us</a></li>
