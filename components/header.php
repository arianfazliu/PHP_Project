...
<body>
	<div class="nav">
		...
		<div class="nav-right">
			...
			<li><a class="spanat <?php active('info.php');?>" href="http://localhost:82/PHP_project/dashboard/info.php">Info</a></li>
			<li><a class="spanat <?php active('quiz.php');?>" href="http://localhost:82/PHP_project/dashboard/quiz.php">Ice Breaker</a></li>
		    ...
		    <li><a class="spanat <?php active('languages.php');?>" href="http://localhost/Webucator/ClassFiles/PHPBasics/Demos/PHP_project/dashboard/languages.php">Courses</a></li>
			<li><a class="spanat <?php active('info.php');?>" href="http://localhost/Webucator/ClassFiles/PHPBasics/Demos/PHP_project/dashboard/info.php">Info</a></li>
			<li><a class="spanat <?php active('quiz.php');?>" href="http://localhost/Webucator/ClassFiles/PHPBasics/Demos/PHP_project/dashboard/quiz.php">Ice Breaker</a></li>
